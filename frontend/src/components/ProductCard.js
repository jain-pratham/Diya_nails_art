  ...
  return (
    <Link href={productHref} className="block w-full">
      <div className="w-full flex flex-col cursor-pointer group/card">
        <div className="relative w-full aspect-square rounded-2xl overflow-hidden mb-3 md:mb-4 bg-[#F8F1E7]">
          {product.discount && (
        ...
        <div className="px-1">
          <h3 className="text-[13px] sm:text-[14px] text-[#555555] font-normal leading-relaxed mb-1 line-clamp-2">
            {product.name}
          </h3>
          <div className="flex items-center gap-2 text-[13px] sm:text-[14px]">
            <span className="text-[#C181C8] font-semibold">{product.price}</span>
